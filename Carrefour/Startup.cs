...
using Carrefour.Repository.Repositories.Class;
using Carrefour.Repository.Repositories.Interface;
using Carrefour.Services.Class;
...
namespace Carrefour
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Linking Service with web API controller
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Carrefour", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Carrefour v1"));
            }
